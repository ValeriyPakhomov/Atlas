...
| [0010](0010-data-tiers-and-model-routing.md) | Data sensitivity tiers govern model routing | Accepted |
| [0011](0011-goals-are-owner-authored-state.md) | Objectives, preferences and constraints are owner-authored canonical state | Accepted |
...
[the 2026-08 cognitive-expansion review](../reviews/2026-08-cognitive-expansion.md).
ADR-0010 and ADR-0011 are accepted. The remaining proposed ADRs block only their specific
later queue items — see the table in `../BUILD_QUEUE.md`.
